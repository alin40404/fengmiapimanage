...
HTML;
	...
	public function listsJson(){
		...
		$sql = 'SELECT a.Id,a.cateId,a.lang,a.link,a.isShow,a.title,a.orderNum,a.addTime,c.cateName,a.addUserId,admin.adminName FROM '.$table.' AS a LEFT JOIN '.$table_category.' AS c ON a.cateId=c.Id left join '.$table_admin.' as admin on admin.Id=a.addUserId WHERE 1=1';
...
// 			unset($arr_post['no']);//编号自动生成 ，不能修改
			...
			if(isNullOrEmpty(@$arr_post['cateId'])){
				$arr_post['cateId']=0;
			}
