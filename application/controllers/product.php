...
class Product extends CI_Controller{
	...
	public function __construct(){
		...
		$this->Common_Model->table='product';
	}
...
HTML;
	...
	public function listsJson(){
		...
		$sql = 'SELECT a.Id,a.cateId,a.lang,a.no,a.isHot,a.title,a.orderNum,a.addTime,c.cateName,a.addUserId,admin.adminName FROM '.$table.' AS a LEFT JOIN '.$table_category.' AS c ON a.cateId=c.Id left join '.$table_admin.' as admin on admin.Id=a.addUserId WHERE 1=1';
