...
HTML;
	...
	public function listsJson(){
		...
		$sql = 'SELECT a.Id,a.lang,a.no,a.title,a.isHot,a.isTop,a.orderNum,a.hitsNums,a.addTime,c.cateName,a.editor,admin.adminName FROM '.$table.' AS a LEFT JOIN '.$table_category.' AS c ON a.cateId=c.Id left join '.$table_admin.' as admin on admin.Id=a.addUserId WHERE 1=1';
