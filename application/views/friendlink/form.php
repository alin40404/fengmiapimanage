	...
	<form action="<?=@$dealUrl?>" method="post" class="formTable">
		<table width="100%" align="center" border="0" cellpadding="0"
			...
			<tbody>
				...
				<tr>
					<td class="eleName"><span class="need">*</span>链接标题:</td>
				...
				<tr style="display: table-row;">
					...
					<td class="eleCont"><input type="text" name="link"
						value="<?=@$link?>" class="input_text" datatype="*1-200"
				...
				<tr>
					<td class="eleName"><span class="need">*</span>链接备注:</td>
