		...
		<table width="100%" align="center" border="0" cellpadding="0"
			...
			<tbody>
				<tr>
					...
					<td class="eleCont"><input type="text" name="gName" value="<?=@$obj->gName ?>"
						class="input_text Validform_error" datatype="*" nullmsg="请填写"
						errormsg="填写有误"></td>
					<td class="eleTip"><div class="Validform_checktip">请填写</div></td>
				</tr>
				<tr>
					<td class="eleName"><span class="need">*</span> 排序数组:</td>
					<td class="eleCont"><input type="text" name="orderNum" value="<?php if(!isNullOrEmpty(@$obj->orderNum)){echo @$obj->orderNum ;}else{echo '0';} ?>"
