...
<link rel="stylesheet" type="text/css"
	href="/czvvLtd/application/assets/bootstrap/css/bootstrap.css">

<link rel="stylesheet" type="text/css"
	href="/czvvLtd/application/assets/admin/css/theme.css">
<link rel="stylesheet"
	href="/czvvLtd/application/assets/font-awesome/css/font-awesome.css">

<script src="/czvvLtd/application/assets/jquery-1.7.2.min.js"
...
<body class="">
			...
			<ul class="nav pull-right">
				...
				<li id="fat-menu" class="dropdown"><a href="#" role="button"
					...
					<ul class="dropdown-menu">
						...
						<li><a tabindex="-1" href="admin/login">Logout</a></li>
					</ul></li>

			</ul>
			<a class="brand" href="index.html"><span class="first">Your</span> <span
					...
					<div class="block span6">
						...
						<div class="block-body">
							...
							<p>Fava bean jícama seakale beetroot courgette shallot amaranth
								...
								brussels sprout green bean. Spring onion broccoli chicory
	...
	<script src="/czvvLtd/application/assets/bootstrap/js/bootstrap.js"></script>
