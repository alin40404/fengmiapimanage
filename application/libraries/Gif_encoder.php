<?php
	...
	class Gif_encoder 
	{
		...
		var $VER = "Gif_encoder V2.06";        /* Encoder version             */  
		...
		public function Gif_encoder ($GIF_src, $GIF_dly = 100, $GIF_lop = 0, $GIF_dis = 0,  $GIF_red = 0, $GIF_grn = 0, $GIF_blu = 0, $GIF_mod = 'bin' ) 
		{  
